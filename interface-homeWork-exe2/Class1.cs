...
namespace IShape
{
    ...
    internal class Circle : IShape
    {
        ...
        public void Roll() { MessageBox.Show("Circle"); }
    ...
    internal class Moon : IShape
    {
        ...
        public void Roll() { MessageBox.Show("Moon"); }
        
    }
    internal class Runner
    {
        Circle circle1 = new Circle(7, "RED", 6);
        public void Run() { circle1.Roll(); }
        
        public  IShape Max(IShape shape1,IShape shape2){
            if (shape1.codcodim < shape2.codcodim) return shape2;
            else return shape1;  
        }
    }
}
